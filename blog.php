...
<body>
    ...
    <div class="boxed_wrapper ltr">
        ...
        <!-- news-style-two -->
        <section class="news-style-two blog-grid pt_120 pb_120">
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-two wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="blog-details.php"><img src="assets/images/news/news-6.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <div class="post-date">
                                    ...
                                    <ul class="post-info">
                                        <li><i class="icon-32"></i><a href="blog-details.php">Admin</a></li>
                                        <li><i class="icon-33"></i>4 Comment</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-two wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="blog-details.php"><img src="assets/images/news/news-7.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <div class="post-date">
                ...
                <!-- <div class="pagination-wrapper centred pt_50">
                    <ul class="pagination">
                        <li><a href="blog.php"><i class="icon-40"></i></a></li>
                        <li><a href="blog.php" class="current">1</a></li>
                        <li><a href="blog.php">2</a></li>
                        <li><a href="blog.php">3</a></li>
                        <li><a href="blog.php"><i class="icon-41"></i></a></li>
                    </ul>
                </div> -->
            </div>
        </section>
